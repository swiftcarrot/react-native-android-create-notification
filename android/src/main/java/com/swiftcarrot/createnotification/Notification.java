...
public class Notification {
    ...
    public android.app.Notification build() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            String channelID = "channel_0000";
            String channelName = "Local notification";
        ...
        notificationBuilder.setVibrate(new long[]{1000, 500, 2000});
        notificationBuilder.setLights(Color.BLUE, 2000, 1000);
